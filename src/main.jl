...
println("Before training: $(test_model(m, train_data))")

train!(m, train_data)

println("After training on training data: $(test_model(m, train_data))")

println("Test data: $(test_model(m, test_data))")
